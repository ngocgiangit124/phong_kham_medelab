...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="admin/nhombenh/them">Nhóm Bệnh</a></li>
    ...
    <section class="content">
        <div class="box box-warning">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Thêm Bệnh</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <form role="form" action="admin/nhombenh/them" method="post" enctype="multipart/form-data">
                    <!-- input states -->
                    ...
                    <div class="form-group">
                        ...
                        <input  class="form-control" name="txtTen" id="inputError" placeholder="Tên bệnh ...">
                        @if(count($errors)>0)
