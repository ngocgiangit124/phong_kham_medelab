...
Route::group(['prefix'=>'admin', 'middleware'=>'CheckLogin'],function ()
{
    ...
    {
        Route::get('danhsachwait','LichKhamController@getDanhSachWait');
        Route::get('danhsachpassed','LichKhamController@getDanhSachPassed');
        Route::get('danhsachfailed','LichKhamController@getDanhSachFailed');
        Route::get('them','LichKhamController@getThem');
        Route::post('them','LichKhamController@postThem');
        Route::get('sua/{id}','LichKhamController@getSua');
...
Route::group(['prefix'=>'trangchu'],function ()
{
    ...
    Route::group(['prefix'=>'ajax'],function ()
    {
        Route::get('chuyenkhoa/{id}','AjaxController@getChuyenKhoa');
    });
